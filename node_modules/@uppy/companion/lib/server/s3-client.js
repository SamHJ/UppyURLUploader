...
module.exports = (companionOptions) => {
    ...
    if (companionOptions.providerOptions.s3) {
        ...
        const s3ClientOptions = Object.assign({ signatureVersion: 'v4', endpoint: s3ProviderOptions.endpoint, region: s3ProviderOptions.region, 
            // backwards compat
            useAccelerateEndpoint: s3ProviderOptions.useAccelerateEndpoint }, rawClientOptions);
